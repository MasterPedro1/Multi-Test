...
public class Player_Controller : FSM
{
    ...
    private bool enSuelo = false; // Verificar si el jugador esta en el suelo
    ...
    protected override void FSMUpdate()
    {
        ...
        else
        {
            ...
            // Saltar si se presiona la tecla de espacio y el jugador est� en el suelo
    ...
    {
        // Verificar si el jugador est� en contacto con la capa "Suelo"
    ...
    {
        // Verificar si el jugador ya no est� en contacto con la capa "Suelo"
        if (collision.gameObject.layer == LayerMask.NameToLayer("Suelo"))
        {
            enSuelo = false;
        }
